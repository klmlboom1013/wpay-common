...
//    }
//
//    @After("execution(* com.wpay.common.templates.adapter.out.external.*External.*Run(..))")
//    @Override
//    public void after(JoinPoint joinPoint) {
//        log.debug("[After] => {}", joinPoint.getSignature().getName());
//    }
//
//    @AfterReturning(pointcut = "execution(* com.wpay.common.templates.adapter.out.external.*External.*Run(..))", returning = "result")
//    @Override
...
//    }
//
//    @AfterThrowing(pointcut = "execution(* com.wpay.common.templates.adapter.out.external.*External.*Run(..))", throwing = "e")
//    @Override
